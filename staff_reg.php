...
<table>
        <tr>
            <td><h1>Staff Registration</h1></td>
        </tr>
        <tr>
    ...
    if($results){
        if($results->num_rows){
            ...
            if($pwd1 != $pwd2){
                ...
                $sql2 = "insert into registration(name,email,pwd,ph,address,dob,blood,approval,rank,role)values('$uname','$email','$pwd1','$ph','$address','$dob','$blood','y','Undefined','staff')";
